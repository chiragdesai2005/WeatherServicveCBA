...
public class WeatherServiceImpl implements WeatherService {
	...
	public ResultData callWebserviceForResultData() throws Exception {
		...
		System.out.println("Using this url to call remote service "
				+ Utility.getInstsnace().getserviceURL());
		WebResource webResource = client.resource(Utility.getInstsnace()
				.getserviceURL());
		...
		Gson gson = new Gson();
		ResultData resultData = gson.fromJson(output, ResultData.class);

		System.out.println("Object cast successfully .... \n" + resultData);
		return resultData;
	}
